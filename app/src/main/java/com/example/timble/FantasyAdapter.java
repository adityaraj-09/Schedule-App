...
public class FantasyAdapter extends RecyclerView.Adapter<FantasyAdapter.ViewHolder> {
    ...
    public FantasyAdapter(Context context, List<Books> list) {
    ...
    @NonNull
    @Override
    public FantasyAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.item_book,parent,false);
        return new FantasyAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FantasyAdapter.ViewHolder holder, int position) {
